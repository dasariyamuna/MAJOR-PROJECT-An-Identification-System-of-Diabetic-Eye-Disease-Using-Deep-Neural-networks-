...
def brainstrokepredict(request):
    ...
    if predict == 0:
        ...
        data = "Macular_Edema Predicted"
    elif predict == 2:
        data = "No Diabetic Retinopathy Predicted"
    else:
        data = "No Macular_Edema"
    ...
    # Draw a rectangle in the center area (you can adjust coordinates as needed)
    (h, w) = output.shape[:2]
    ...
    cv2.putText(output, data, (10, 15), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
